        ...
        <div class="d-flex justify-content-center align-items-center">
          ...
          <div class="p-2">
            ...
            <p>
              ...
              Inventore harum natus, aut, voluptate maiores saepe delectus
              accusamus quibusdam officiis fugiat consequatur minus fugit, fuga
              asperiores! Eveniet alias doloremque ratione dolorum!
            </p>
          </div>
        </div>
